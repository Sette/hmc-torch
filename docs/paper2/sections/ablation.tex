...
\textbf{Bold}: best per dataset. ``---'' = infeasible (dense R OOM on 12\,GB GPU).}
\label{tab:ablation}
...
cellcycle\_GO, the dense R-matrix is infeasible (12\,GB GPU cannot
allocate the $4126^2 \times \text{batch}$ tensor), requiring the
